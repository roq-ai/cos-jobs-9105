...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'healthcare_staff.create': {
    roles: ['business-owner', 'recruitment-manager'],
    key: 'new-healthcare-staff-registered',
    tenantPath: ['organization', 'user', 'healthcare_staff'],
    userPath: [],
  },
  'healthcare_staff.update': {
    roles: ['recruitment-manager'],
    key: 'healthcare-staff-profile-updated',
    tenantPath: ['organization', 'user', 'healthcare_staff'],
    userPath: [],
  },
  'healthcare_staff.delete': {
    roles: ['business-owner', 'recruitment-manager'],
    key: 'healthcare-staff-profile-deleted',
    tenantPath: ['organization', 'user', 'healthcare_staff'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'recruitment-manager', 'it-support'];
